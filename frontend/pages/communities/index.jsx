	...
	return (
		<>
			...
			<ItemBlock title="HotTake Home">
				Our homepage is an open space for any general HotTakes. If you have a HotTake specific to a
				community, make sure to post it there.
			</ItemBlock>
			...
			<ItemBlock title="Your University Space...">
				HotTake is always looking to expand the communities we offer. However, we require a certain
				amount of demand before officially establishing a community. To create a community, reach
				out to{" "}
